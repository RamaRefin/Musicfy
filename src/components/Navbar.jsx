...
const Navbar = () => {
  return (
    <nav className="w-full flex items-center justify-between bg-green-500 text-white px-10 py-6 shadow-md">
      {/* Logo */}
      ...
      <ul className="hidden md:flex space-x-10 text-base">
        ...
        <li><a href="/genre" className="hover:text-green-400 px-3 py-2 rounded transition">Genres</a></li>
        <li><a href="/about" className="hover:text-green-400 px-3 py-2 rounded transition">About</a></li>
      </ul>
